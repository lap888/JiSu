...
const URL1 = "https://squirrel.kxbwmedia.com/ditch/task"
class Zbangbang extends Component {
    constructor(props) {
        super(props);
        this.state = {
            height: 0,
            ...
            url: `https://h5.ads66.com/home?device_ids=%7B%221%22%3A%2299001008920806%22%2C%222%22%3A%2299001008920807%22%7D&media_id=dy_59610931&show_type=0&user_id=521855688&sign=41fa4efa3c86fba12d686fbe61833bbd`
        };
            ...
            return (
                <SafeAreaView>
                    <View style={{ alignItems: "center", height: Metrics.screenHeight }}>
                        ...
                        }} style={{ height: 50 }}><Text>获取设备ID</Text></TouchableOpacity>
                        <WebView
...
export default connect(mapStateToProps, mapDispatchToProps)(Zbangbang)
// 样式
