...
class PreViewTask extends Component {
   ...
   */
    renderGradient() {
        let { avatar, yoBang, userId, rewardType } = this.props;
        return (
            <View style={{}}>
                <View style={{ flexDirection: 'row', backgroundColor: Colors.White, paddingHorizontal: 15, paddingVertical: 10 }}>
                    ...
                    <View style={Styles.setting}>
                        ...
                        <Text style={Styles.nickname} numberOfLines={2}>{`${yoBang.unitPrice} ${rewardType == 1 ? '元' : '糖果'}`}</Text>
                    </View>
                </View>
                {this.renderProfile()}
            </View>
                                ...
                                : item.type == 2 || item.type == 3 || item.type == 5 ?
                                    ...
                                    : item.type == 6 ?
                                        <View style={{ alignItems: 'center', width: 120 }}>
                                            ...
                                            <View style={{ borderWidth: 1, width: 120, marginLeft: 5, borderColor: Colors.C6, borderRadius: 5, alignItems: 'center' }}>
