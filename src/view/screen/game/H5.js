...
import { View, Text, ToastAndroid, BackHandler, TouchableWithoutFeedback, Image, Platform, PanResponder, Linking, Alert } from 'react-native'
...
export default connect(mapStateToProps, mapDispatchToProps)(H5);