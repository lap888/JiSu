...
class TaskApealList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dataList: [],
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: Colors.backgroundColor }}>
                ...
                <Header backgroundColor={Colors.statusBar} rightStyle={{ color: Colors.black }} titleStyle={{ color: Colors.black }} title="反馈记录" />
                {this.renderList()}
            </View>
        );
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(TaskApealList);
