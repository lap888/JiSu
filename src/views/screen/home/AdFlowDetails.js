    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: Colors.White }}>
                ...
                <Header leftIconColor={Colors.black} title={data.name} titleStyle={{ color: Colors.black }} statusBarBackgroundColor={Colors.statusBar} backgroundColor={Colors.statusBar} />
                <View style={{ flex: 1 }}>
                    <RefreshListView
                        data={detailList}
                        ListHeaderComponent={() => {
